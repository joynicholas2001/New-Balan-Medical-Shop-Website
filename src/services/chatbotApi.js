// Mock API functions for the chatbot
// These are placeholder functions that simulate backend responses
// In production, replace these with actual API calls

// Import products from website data
...
// Get products from the actual website data
...
const generateResponse = async (intent, message) => {
    ...
    const allProducts = getWebsiteProducts();
